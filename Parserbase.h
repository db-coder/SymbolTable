...
// $insert polymorphicSpecializations
    ...
    template <>
    struct TypeOfBase<Tag__::LIST>
    {
        typedef std::vector<exp_astnode*> DataType;
    };

    template <>
    struct TypeOfBase<Tag__::FLOAT1>
    {
        typedef float DataType;
    };

    template <>
    struct TypeOfBase<Tag__::INT1>
    {
    ...
    template <>
    struct TypeOfBase<Tag__::STMAST>
    {
        typedef stmt_astnode* DataType;
    };
